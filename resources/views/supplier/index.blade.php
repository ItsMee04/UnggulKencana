            ...
            <div class="page-header">
                ...
                <div class="page-btn">
                    <a href="#" class="btn btn-added" data-bs-toggle="modal" data-bs-target="#addEmployee"><i
                            data-feather="plus-circle" class="me-2"></i> Tambah Supplier</a>
                </div>
            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="action-table-data">
                                            <div class="edit-delete-action">
                                                ...
                                                <a class="me-2 p-2"
                                                    onclick="confirm_modal('delete-supplier/{{ $item->id }}');"
                                                ...
                                                <form method="POST" enctype="multipart/form-data">
                                                    <div class="modal-body text-start">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" value="{{ $item->kodesupplier }}"
                                                    ...
                                                    <div class="modal-body text-start">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" name="kodesupplier"
                                                                value="{{ $item->kodesupplier }}" class="form-control"
                                                                readonly>
                                                        </div>
                                                        <div class="mb-3">
                                                            <label class="form-label">Nama</label>
                                                            <input type="text" name="supplier"
                                                                value="{{ $item->supplier }}" class="form-control">
                                                        </div>
                                                        <div class="mb-3">
                                                            <label class="form-label">Kontak</label>
            ...
            <div class="modal-content modal-content-demo">
                ...
                <form action="supplier" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body text-start">
                        <div class="mb-3">
                            <label class="form-label">Kode Supplier</label>
                            <input type="text" name="kodesupplier" value="{{ $kodesupplier }}" class="form-control"
                                readonly>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Nama</label>
